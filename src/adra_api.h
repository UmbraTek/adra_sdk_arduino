...
private:
    ...
    static int16_t hex_to_int16_big(uint8_t *a, uint8_t i)
    {
    ...
    static int32_t hex_to_int24_big(uint8_t *a, uint8_t i)
    {
        unsigned long i1 = (unsigned long)(a[i]);
        unsigned long i2 = (unsigned long)(a[i + 1]);
    ...
    static int32_t hex_to_int32_big(uint8_t *a, uint8_t i)
    {
        unsigned long i1 = (unsigned long)(a[i]);
        unsigned long i2 = (unsigned long)(a[i + 1]);
        unsigned long i3 = (unsigned long)(a[i + 2]);
    ...
    static void int16_to_hex_big(uint16_t a, uint8_t *b)
    {
        b[0] = (uint8_t)(a >> 8);
        b[1] = (uint8_t)a;
    }

    static void int32_to_hex_big(uint32_t a, uint8_t *b)
    {
    ...
    static float int_to_rad(uint32_t value)
    {
        return (float)value * 0.00001;
    }
    static uint32_t rad_to_int(float value)
    {
        return (uint32_t)(value * 100000);
    }
